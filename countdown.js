 ...
 */
      ...
      $(this).find("#counter_s").html(event.strftime('%S'));
   	...
   	//$(this).find("#counter_d").html('52');
    /*
    $(this).find("#counter_d").html('90');
    $(this).find("#counter_h").html('00');
    $(this).find("#counter_m").html('00');
    $(this).find("#counter_s").html('00');
    */
  });

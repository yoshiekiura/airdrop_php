...
<div id="home" class="home flex">
    ...
    <div class="ico animated fadeInUp">
        <span class="ico-title"><?= $t['chrono_icoend'] ?></span>
        ...
        <div class="ico-text flex">
            <div class="ico-text-block left">
                <?=number_format($total_sales)?> <br>
                SREUR tokens
            </div>
            <div class="ico-text-block right"><?= $t['3 million'] ?></div>
        </div>
        <div class="ico-bar">
            <?php $progress = 0//$softcap / $hardcap * 100;?>
            <div class="ico-bar-tokens flex column" style="width:<?= $progress < 25 ? 25 : $progress ?>%">
                <strong id="total_sales"> &euro;2.143.094 Raised</strong> 
            </div>
        </div>
        <div class="ico-bar-text">
            <span class="ico-cap-bar" ><?= $t['softcap'] ?></span>
            <span class="ico-cap-bar" style="float:right"><?= $t['hardcap'] ?></span>
        </div>
        <ul class="ico-buttons">
            <ul class="btn-counter">
            <li><a href="/login?redirect=ico-purchase"><div class="ico-buy" style="background-color: #F00;color:#fff;"><?= $t['buynow_button'] ?></div></a></li>
                
            <li><a href="<?=base_url()?>contact.php"><div class="ico-whitepaper" style="width: 100%;"><?= $t['big_investors'] ?></div></a></li>
            </ul>
            <ul class="btn-counter">
            <li><a href="whitepaper.php"><div class="ico-whitepaper">WHITEPAPER</div></a></li>
            <li><a href="<?=base_url()?>register"><div class="ico-buy" style="width: 100%;"><?= $t['join_the_project']?></div></a></li>
            </ul>
            <li></li>
...
<div class="partners wow fadeInUp d025" style="background-color:#000;padding-bottom:100px;margin-bottom:5px;">
    ...
    -->
        <a href="#">
            <img border="0" src="assets/tokenairdrop.png" alt="Token Airdrop" style="width:auto;height:115px"/>
        </a>
        <a href="https://p2pb2b.io/">
            <img border="0" src="assets/p2pb2b.png" style="width:150px;height:auto"/>
        </a>
    <!--
        <a href="https://www.idax.pro/#/">
            <img border="0" src="assets/idax2.png" style="width:150px;height:auto"/>
        </a>
    -->
    </div>
</div>
...
<div class="partners wow fadeInUp d025" style="background-color:#000;">
    <span style="color:#ffffff;"><?= $t['as seen on'] ?></span>
            <div class="partners-images">
                ...
                <!--
                <span id="icoholder-widget-big-green-22492"></span><script type="application/javascript" async="async" src="https://icoholder.com/en/widget/big-green/22492.js?"></script>
                -->


                <span id="icoholder-widget-big-green-listed-22492"></span><script type="application/javascript" async="async" src="https://icoholder.com/en/widget/big-green-listed/22492.js"></script>
...
<!--					<td colspan="2" class="about-sr wow fadeInUp d020">--><?//= $t['sec_about_about'] ?><!--</td>-->
        ...
        <div class="video-box" >
            <iframe id="vplayer" class="embed-responsive-item mivideo"  src="<?= $t['youvidid'] ?>" frameborder="0"></iframe>
        </div>
        </div>
    </div>
</div>
...
<div id="token" class="token flex column black-title">
    ...
    <div class="token-content flex">
        ...
        <div class="token-imgs column">
            <img class="wow fadeInUp d080" src="assets/token_chart_1.png">
            <img class="wow fadeInUp d090" src="assets/token_chart_2.png">
        </div>
    </div>
...
<!--
        <div class="team-mate wow fadeInUp d065">
            <img src="assets/GuillermoValleMendoza.png" alt="Guillermo">
            <span class="name">Guillermo Valle Mendoza</span>
...
-->
        <div class="team-mate wow fadeInUp d065">
            <img src="assets/EuricSantis.png" alt="Euric">
            <span class="name">Euric Santis</span>

            <span class="job"><?= $t['auditor_blockchain'] ?></span>

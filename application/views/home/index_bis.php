...
<?php require_once 'header_bis.php'; ?>
    ...
    <div class="home-text animated fadeInUp d125" style="font-size: 35px;">
        ...
        <div class="partners wow fadeInUp d025">
            <div class="partners-images">
                <a href="#">
                    <img class="latoken" border="0" src="assets/latoken_black.png" style="width:350px;height:auto"/>
                </a>
                <!--
            ...
            <span style="color:#000;font-size:30px">Official Partner</span>
        </div>
    </div>
    ...
    <div class="ico animated fadeInUp">
        ...
        <div class="ico-text flex">
            <div class="ico-text-block left">
                <?=number_format(round($softcap))?> <br>
                SREUR tokens
            </div>
            <div class="ico-text-block right"><?= $t['3 million'] ?></div>
        </div>
        <div class="ico-bar">
            <?php $progress = $softcap / $hardcap * 100;?>
            <div class="ico-bar-tokens flex column" style="width:<?= $progress < 25 ? 25 : $progress ?>%">
                <strong id="total_sales"> &euro;<?=number_format($total_sales)?> Raised</strong> 
            </div>
        </div>
...
<div class="partners wow fadeInUp d025" style="background-color:#000;padding-bottom:100px;margin-bottom:20px;">
...
<div class="partners wow fadeInUp d025" style="background-color:#000;">
    <span style="color:#ffffff;"><?= $t['as seen on'] ?></span>
            <div class="partners-images">
                ...
                <a href="#" target="_blank" rel="nofollow" title="TokenAirdrop"><img border="1" src="assets/tokenairdrop.png" width="400px" height="125px" alt="Token Airdrop"/></a>

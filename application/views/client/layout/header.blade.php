<header class="main-header">
	...
	<a href="{{base_url()}}index" class="logo">
		...
		<span class="logo-lg">
			<img src="{{base_url()}}asset/img/logo-white.png" alt="logo" class="light-logo">
				...
				<li class="dropdown user user-menu">
					...
					<ul class="dropdown-menu scale-up">
						...
						<li class="user-header">
							<img src="{{base_url()}}asset/uploads/{{$userdata->avatar}}" class="float-left rounded-circle" alt="User Image">

							<p>
                            {{empty($userdata->first_name) ? $userdata->username : $userdata->first_name.' '.$userdata->second_name}}
								<small class="mb-5">{{$userdata->email}}</small>
								<a href="{{base_url()}}ico-purchase" class="btn btn-danger btn-sm btn-rounded">Buy Tokens</a>
							</p>
						</li> 
						<!-- Menu Body -->
						<li class="user-body">
							<div class="row no-gutters">
								<div class="col-12 text-left">
									<a href="{{base_url()}}profile"><i class="mdi mdi-face"></i> My Profile</a>
								</div>
								<div class="col-12 text-left">
									<a href="{{base_url()}}settings"><i class="ion ion-settings"></i> Account Settings</a>
								</div>
								<div class="col-12 text-left">

...
<section class="content-header">
    ...
    Are you an Accredited Investor? -- <?php echo $is_accredited_investor ?>
    </h1>
    <p />
    ...
    <hr>
    <p>
        We remind you that accredited investors are those who meet at least one of the following conditions:
    </p>
    ...
    <p>
        - Minimum net worth of 1 million dollars excluding the value of your main residence</br>
        - Minimum annual income of 200 thousand dollars (300 thousand jointly to your spouse) </br>during the two years previous and has expectations to continue maintaining the level of income in the future.
    </p>
    ...
    <p>
        - Read the <a href="https://www.ecfr.gov/cgi-bin/retrieveECFR?gp=&SID=8edfd12967d69c024485029d968ee737&r=SECTION&n=17y3.0.1.1.12.0.46.176">Electronic Code of Federal Regulations</a>

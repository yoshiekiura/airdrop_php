...
<!-- Select2 -->
<link rel="stylesheet" href="<?php echo e(base_url()); ?>assets/vendor_components/select2/dist/css/select2.min.css">
<!-- bootstrap datepicker -->   
<link rel="stylesheet" href="<?php echo e(base_url()); ?>assets/vendor_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
...
<?php $__env->startSection("ico-purchase_test", "active"); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 br-1">
                            ...
                            <div class="row">
                                <?php $__currentLoopData = COMPANY_BANK_ACCOUNTS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-12 bt-1 mt-5 pt-5"><h4><?php echo e($country); ?></h4></div>
                                    <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-6"><strong><?php echo $value; ?></strong></div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                ?>
                                    <label class="col-md-4 control-label"><?php echo e($val); ?></label>
                                    <div class="col-md-8">
                                        <?php if($key == "username" || $key == "full_name" || $key == "country" || $key == "email"): ?>
                                            <input name="<?php echo e($key); ?>" class="form-control" type="text" value="<?php echo e($value); ?>" <?=empty($value) ? '' : 'disabled'?> required>
                                        <?php elseif($key == "transfer_date"): ?>
                                            <input id="<?php echo e($key); ?>" name="<?php echo e($key); ?>" class="form-control" type="text" required>
                                        <?php elseif($key == "bank"): ?>
                                            <input name="<?php echo e($key); ?>" class="form-control" type="text" required>
                                        <?php elseif($key == "amount"): ?>
                                            <input name="<?php echo e($key); ?>" class="form-control" type="number" required>
                                        <?php elseif($key == "currency"): ?>
                                            <select class="form-control" name="<?php echo e($key); ?>" required>
                                                <?php $__currentLoopData = CURRENCIES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $initial => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($initial); ?>"><?php echo e($initial); ?> : <?php echo e($info['full_name']); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        <?php else: ?>
                                            <input name="<?php echo e($key); ?>" class="form-control" type="text" required>
...
<!-- Select2 -->
<script src="<?php echo e(base_url()); ?>assets/vendor_components/select2/dist/js/select2.full.js"></script>
<!-- webticker -->
<script src="<?php echo e(base_url()); ?>assets/vendor_components/Web-Ticker-master/jquery.webticker.min.js"></script>
<!-- bootstrap datepicker -->
...
<script>
    var coingate_rates = <?php echo $coingate_rates; ?>;
    ...
    var token_price = <?php echo e($token_price); ?>;
    var discount_rate = <?php echo e($discount_rate); ?>;
    var guarantee_rate = <?php echo e($guarantee_rate); ?>;
    ...
    $(function () {
        ...
        stripe_handler = StripeCheckout.configure({
            key: '<?php echo e($stripe_public_key); ?>',

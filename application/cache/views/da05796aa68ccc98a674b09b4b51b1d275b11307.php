...
<?php $__env->startSection("sidebar_profile", "active"); ?>
		...
		<div class="col-xl-4 col-lg-5">
			...
			<div class="box bg-dark bg-deathstar-dark">
				<div class="box-body box-profile">
					...
					<h2 class="profile-username text-center mb-0"><?php echo e(empty($userdata->first_name) ? $userdata->username : $userdata->first_name.' '.$userdata->second_name); ?></h2>

					<h4 class="text-center mt-0"><i class="fa fa-envelope-o mr-10"></i><?php echo e($userdata->email); ?></h4>

					<div class="row social-states">
						<div class="col-6 text-right"><?php echo e($userdata->total_ico_token); ?> SREUR</div>
						<div class="col-6 text-left"><?php echo e($userdata->mlm_flag? $userdata->mlm_commission : $userdata->total_score); ?> CSR</div>
					</div>
						...
						<div class="col-12">
                            <?php echo form_open(base_url().'client/profile/update_kyc_info',array('class' => 'form-horizontal form-element col-12','id'=>'form_personal_details','method'=>'post')); ?>
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control" name="first_name" id="kyc_first_name" value="<?php echo e($userdata->first_name); ?>" placeholder="" required>
									</div>
									<label for="inputSecondName" class="col-sm-2 control-label">Second Name</label>
									<div class="col-sm-4">
										<input type="text" class="form-control" name="second_name" id="kyc_second_name" value="<?php echo e($userdata->second_name); ?>" placeholder="" required>
									</div>
								</div>
								<div class="form-group row">
                                    <label for="inputGender" class="col-sm-2 control-label">Gender</label>
									<div class="col-sm-4">
                                        <select class="form-control" name="gender" value="<?php echo e($userdata->gender); ?>">
                                            <option <?php echo e(strtolower($userdata->gender) == 'male' ? 'selected' : ''); ?> >Male</option>
                                            <option <?php echo e(strtolower($userdata->gender) == 'female' ? 'selected' : ''); ?> >Female</option>
                                        </select>
										<!-- <input type="text" class="form-control" name="gender" id="kyc_gender" value="<?php echo e($userdata->gender); ?>" placeholder="" required> -->
									</div>
									<label for="inputBirth" class="col-sm-2 control-label">Date of Birth</label>
									<div class="col-sm-4">
										<input type="text" class="form-control" name="birth" id="kyc_birth" value="<?php echo e($userdata->birth); ?>" placeholder="" required>
									</div>
								</div>
								<div class="form-group row">
									<label for="inputPhone" class="col-sm-2 control-label">Phone</label>
									<div class="col-sm-4">
										<input type="number" class="form-control" name="phone" id="kyc_phone" value="<?php echo e($userdata->phone); ?>" placeholder="" required>
									</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="address" id="kyc_address" value="<?php echo e($userdata->address); ?>" placeholder="" required>
									</div>
								</div>
								<!-- <div class="form-group row">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <?php foreach(PROOF_TYPES['identity'] as $text => $fulltext) {?>
                                        <input name="identity_proof_type" type="radio" value="<?php echo e($text); ?>" id="identity_<?php echo e($text); ?>" class="with-gap radio-col-purple" checked/>
                                        <label for="identity_<?php echo e($text); ?>"><?php echo e($fulltext); ?></label>
                                    <?php }?>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="demo-radio-button">
                                        <?php foreach(PROOF_TYPES['address'] as $text => $fulltext) {?>
                                            <input name="address_proof_type" type="radio" value="<?php echo e($text); ?>" id="address_<?php echo e($text); ?>" class="with-gap radio-col-purple" checked/>
                                            <label for="address_<?php echo e($text); ?>"><?php echo e($fulltext); ?></label>
                                        <?php }?>
                                    </div>
                                </div>
                                <div class="col-md-7">
...
<script>
    $(document).ready(function(){
        ...
        <?php if(!empty($userdata->country_code)) {?>
            ...
            $("#kyc_country").countrySelect("selectCountry", "<?php echo e($userdata->country_code); ?>");
        <?php }?>


        //disable input fields when KYC is already passed
        if(<?php echo e($userdata->kyc_status); ?> == 2)

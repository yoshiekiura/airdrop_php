...
<?php $__env->startSection("sidebar_dashboard", "class=active"); ?>
	...
	<div class="row">
		<div class="col-md-6 col-12 ">
			<div class="box box-body pull-up">
				...
				<div class="flexbox mt-2">
					<span class="ion ion-ios-heart text-danger font-size-40"></span>
					<span class=" font-size-30"><?php echo e($userdata->mlm_flag? $userdata->mlm_commission : $userdata->total_score); ?> CSR</span>
				</div>
			</div>
		</div>
		...
		<div class="col-md-6 col-12 ">
			<div class="box box-body pull-up">
				...
				<div class="flexbox mt-2">
					<span class="ion ion-ios-heart text-danger font-size-40"></span>
					<span class=" font-size-30"><?php echo e($userdata->total_ico_token); ?> SREUR</span>
				</div>
			</div>
		</div>
	</div>
...
<?php $__env->startPush('plugin_js'); ?>
	...
	<!-- EChartJS JavaScript -->
	<script src="<?php echo e(base_url()); ?>assets/vendor_components/echarts-master/dist/echarts-en.min.js"></script>
	<script src="<?php echo e(base_url()); ?>assets/vendor_components/echarts-liquidfill-master/dist/echarts-liquidfill.min.js"></script>
	
	<!-- This is data table -->
    <script src="<?php echo e(base_url()); ?>assets/vendor_plugins/DataTables-1.10.15/media/js/jquery.dataTables.min.js"></script>

    <!-- Sparkline -->
	<script src="<?php echo e(base_url()); ?>assets/vendor_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>

    <!-- Flip Clock -->
	<script src="<?php echo e(base_url()); ?>assets/vendor_components/FlipClock-master/compiled/flipclock.min.js"></script>
...
<?php $__env->startPush('custom_js'); ?>
        ...
        (function(window, document, $, undefined) {
            $(function() {
                ...
                $("#copy-btn").click(function() {
                    ...
                    el.value = '<?php echo e(base_url()."ref/".$userdata->user_id); ?>';
    ...
    <script src="<?php echo e(base_url()); ?>assets/js/pages/dashboard.js"></script>
	<script src="<?php echo e(base_url()); ?>assets/js/pages/dashboard-chart.js"></script>

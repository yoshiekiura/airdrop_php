						...
						<tr
							...
							<td class="cart_quantity" colspan="1">
								...
								{else}
									...
									<input type="text" value="{*if $has_custom_qty_attribute}{$product.attributes[Product::getCustomQuantityAttributeName($product.id_product)]}{else*}{$customization.quantity}{*/if*}"
										   class="cart_quantity_input form-control grey" name="quantity_{$product.id_product}_{$product.id_product_attribute}_{$id_customization}_{$product.id_address_delivery|intval}"/>
									{assign var='is_dynamically_priced_product' value=Product::isDynamicallyPricedProduct($product.id_product)}
                                                                        {*$is_dynamically_priced_product|@print_r*}

<div class="links flex">
		...
		<div class="footer-column">
			<ul class="wow d050">
				...
				<div class="mail-footer"><a style="color:#ffffff;margin: 0 auto;" href="mailto:info@socialremit.com"><i class="fa fa-envelope"></i> info@socialremit.com</a>
                </div>
</div>
<div class="other-links">
    <a href="<?php echo $d['legal'] ?>"><?=$t['sec_footer_legal_warning']?></a>
    <a href="<?php echo $d['priva'] ?>"><?=$t['sec_footer_privacy_policy']?></a>
    <a href="<?php echo $d['cookies'] ?>"><?=$t['sec_footer_cookies_policy']?></a>
    <a href="<?php echo $d['conds'] ?>"><?=$t['sec_footer_terms_of_service']?></a>
</div>

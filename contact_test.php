...
<form id="frmcontact" class="form-style-9" method="POST" action="/bi_contact.php">
    ...
    <div class="form-group">
        <!--<div class="g-recaptcha" data-theme="light" data-sitekey="6LdnSmgUAAAAAA73gzsLuXknyY8PXI9WaV4dCZP7" id="captcha_container" data-callback="recaptchaCallback"></div>-->
    ...
    var captchaContainer = null;
       var loadCaptcha = function () {
            captchaContainer = grecaptcha.render('captcha_container', {
                'sitekey': "6LdnSmgUAAAAAA73gzsLuXknyY8PXI9WaV4dCZP7",  

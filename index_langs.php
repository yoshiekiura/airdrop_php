<?php require_once 'header_langs.php'; ?>
...
<!--					<td colspan="2" class="about-sr wow fadeInUp d020">--><?//= $t['sec_about_about'] ?><!--</td>-->
            ...
            <div class="video-box">
                <iframe width="640" height="344" allow="autoplay; encrypted-media" id="vplayer" src="https://www.youtube.com/embed/<?= $t['youvidid'] ?>?autoplay=0&controls=0&disablekb=1
	...
	<div id="team" class="team flex column bg black-title">
		...
		<div style="margin: 0 auto" class="team-content flex team-content-1">
			...
			<div class="team-mate wow fadeInUp d040">
				<img src="assets/team_3.png" alt="Miguel Muñoz Garcia">
				<span class="name">Miguel Muñoz Garcia</span>
...
<?php require_once 'footer_langs.php'; ?>

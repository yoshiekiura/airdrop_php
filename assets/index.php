...
<div id="home" class="home flex">
    ...
    <?= $t['tagline'] ?>
    <div class="partners wow fadeInUp d025" style="background-color:#FFF;padding-bottom:100px;margin-bottom:20px;">
        <span style="color:#ffffff;">Official Partner</span>
        <div class="partners-images">
            <a href="#">
                <img border="0" src="assets/latoken_black.png" style="width:350px;height:auto"/>
            </a>
        </div>
    </div>
    ...
    <div class="ico animated fadeInUp">
        ...
        <div class="ico-text flex">
            <div class="ico-text-block left">
                <?=number_format($softcap + 1424425)?> <br>
                SREUR tokens
            </div>
        ...
        <div class="ico-bar">
            ...
            <div class="ico-bar-tokens flex column" style="width:<?= $progress < 10 ? 10 : $progress ?>%"></div>
        </div>

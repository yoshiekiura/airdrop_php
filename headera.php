...
<!--                <div>-->
                <a href="/main?lang=<?php echo $lang?>#about" class="nav-link"><span><?= $t['n_the company'] ?></span></a>
                <a href="main?lang=<?php echo $lang?>#choose" class="nav-link"><span><?= $t['n_whyhow'] ?></span></a>
                ...
                <a href="main?lang=<?php echo $lang?>#token" class="nav-link"><span><?= $t['n_tokens'] ?></span></a>
                <a href="main?lang=<?php echo $lang?>" class="nav-link"><span><?= $t['sec_icowallet'] ?></span></a>
                <a href="main?lang=<?php echo $lang?>#team" class="nav-link"><span><?= $t['n_team'] ?></span></a>
                <a href="news.php?lang=<?php echo $lang ?>" class="nav-link"><span><?= $t['news'] ?></span></a>
                <a href="main?lang=<?php echo $lang?>#faq" class="nav-link"><span><?= $t['n_faq'] ?></span></a>
		
<!--                <a href="/forum" class="nav-link"><span>--><?//= $t['n_community'] ?><!--</span></a>-->
                <a href="/login?redirect=ico-purchase" class="nav-link"><span><?= $t['btnregister'] ?></span></a>
<!--                </div>-->
